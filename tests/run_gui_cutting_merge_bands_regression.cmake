if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI cutting merge-bands regression arguments.")
endif()
...
set(INPUT_PATH_A "${OUTPUT_DIR}/merge_band_a.bmp")
set(INPUT_PATH_B "${OUTPUT_DIR}/merge_band_b.bmp")
...
gis_gui_assert_regression_result(
    "GUI cutting merge-bands regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
