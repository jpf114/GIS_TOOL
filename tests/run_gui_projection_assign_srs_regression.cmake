if(NOT DEFINED GUI_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI projection assign_srs regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/projection_assign_input.tif")
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --select-action assign_srs
        --set-param "input=${INPUT_PATH}"
        --set-param "srs=EPSG:3857"
        --auto-execute
        --quit-on-finish
...
gis_gui_assert_status_only_success(
    "GUI projection assign_srs regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${SCREENSHOT_PATH}"
