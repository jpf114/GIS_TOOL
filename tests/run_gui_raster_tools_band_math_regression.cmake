if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI raster-tools band-math regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/raster_tools_band_math_input.tif")
...
gis_gui_assert_regression_result(
    "GUI raster-tools band-math regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
