if(NOT DEFINED GUI_PATH OR NOT DEFINED GUI_TEST_DATA_HELPER_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI spindex AWEI regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/awei_input.tif")
...
if(NOT "${HELPER_EXIT_CODE}" STREQUAL "0")
    message(FATAL_ERROR "Failed to generate AWEI GUI test raster.")
endif()
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --set-param "green_band=2"
        --set-param "nir_band=4"
        --set-param "swir1_band=5"
        --set-param "swir2_band=6"
        --auto-execute
        --quit-on-finish
