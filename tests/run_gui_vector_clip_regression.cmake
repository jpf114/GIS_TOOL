if(NOT DEFINED GUI_PATH OR NOT DEFINED INPUT_PATH OR NOT DEFINED CLIP_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI vector clip regression arguments.")
endif()
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --set-param "clip_vector=${CLIP_PATH}"
