if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI processing edge regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/edge_input.bmp")
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --set-param "band=1"
        --set-param "edge_method=canny"
        --set-param "low_threshold=40"
        --set-param "high_threshold=120"
        --auto-execute
        --quit-on-finish
...
gis_gui_assert_regression_result(
    "GUI processing edge regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
