if(NOT DEFINED GUI_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI raster inspect info regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/raster_inspect_info_input.tif")
...
gis_gui_assert_status_only_success(
    "GUI raster inspect info regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${SCREENSHOT_PATH}"
