if(NOT DEFINED GUI_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI processing stats regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/processing_stats_input.tif")
...
gis_gui_assert_status_only_success(
    "GUI processing stats regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${SCREENSHOT_PATH}"
