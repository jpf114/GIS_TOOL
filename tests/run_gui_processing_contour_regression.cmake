if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI processing contour regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/contour_input.bmp")
...
gis_gui_assert_regression_result(
    "GUI processing contour regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
