if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI processing glcm regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/glcm_input.tif")
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --select-action glcm_texture
        --set-param "input=${INPUT_PATH}"
        --set-param "output=${OUTPUT_PATH}"
        --set-param "band=1"
        --set-param "kernel_size=5"
        --set-param "glcm_metric=contrast"
        --set-param "glcm_levels=8"
        --auto-execute
        --quit-on-finish
...
gis_gui_assert_regression_result(
    "GUI processing glcm regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
