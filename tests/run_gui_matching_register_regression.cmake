...
set(REFERENCE_PATH "${OUTPUT_DIR}/register_ref.bmp")
set(INPUT_PATH "${OUTPUT_DIR}/register_input.bmp")
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --set-param "transform=affine"
        --set-param "resample=bilinear"
...
gis_gui_assert_regression_result(
    "GUI matching register regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
