...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --set-param "overlay_vector=${OVERLAY_PATH}"
...
if(NOT GUI_EXIT_CODE EQUAL 0)
    message(FATAL_ERROR
        "GUI vector overlay regression failed with exit code ${GUI_EXIT_CODE}\n"
        "stdout:\n${GUI_STDOUT}\n"
        "stderr:\n${GUI_STDERR}")
endif()

if(NOT EXISTS "${OUTPUT_PATH}")
    message(FATAL_ERROR "GUI vector overlay regression did not produce output: ${OUTPUT_PATH}")
endif()
...
if(SCREENSHOT_SIZE EQUAL 0)
    message(FATAL_ERROR "GUI vector overlay regression produced an empty screenshot: ${SCREENSHOT_PATH}")
endif()
