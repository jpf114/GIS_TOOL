if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI processing filter invalid-band regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/filter_invalid_band_input.bmp")
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --set-param "band=9"
        --set-param "filter_type=gaussian"
...
gis_gui_assert_failure_result(
    "GUI processing filter invalid-band regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
