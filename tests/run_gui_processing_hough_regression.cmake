if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI processing hough regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/hough_input.bmp")
...
execute_process(
    COMMAND "${GUI_PATH}"
        ...
        --set-param "band=1"
        --set-param "hough_type=lines"
        --set-param "hough_threshold=10"
        --set-param "min_line_length=4"
        --set-param "max_line_gap=2"
        --auto-execute
        --quit-on-finish
...
gis_gui_assert_regression_result(
    "GUI processing hough regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
