if(NOT DEFINED GUI_PATH OR NOT DEFINED OUTPUT_PATH OR NOT DEFINED SCREENSHOT_PATH)
    message(FATAL_ERROR "Missing required GUI processing threshold invalid-band regression arguments.")
endif()
...
set(INPUT_PATH "${OUTPUT_DIR}/threshold_invalid_band_input.bmp")
...
gis_gui_assert_failure_result(
    "GUI processing threshold invalid-band regression"
    "${GUI_EXIT_CODE}"
    "${GUI_STDOUT}"
    "${GUI_STDERR}"
    "${OUTPUT_PATH}"
